...
namespace brekGPT.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class brekGPTModule : ModuleBase {
    public brekGPTModule() {
		// 
		// brekGPTModule
		// 
		AdditionalExportedTypes.Add(typeof(brekGPT.Module.BusinessObjects.ApplicationUser));
