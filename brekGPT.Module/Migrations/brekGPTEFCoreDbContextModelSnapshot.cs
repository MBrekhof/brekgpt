...
namespace brekGPT.Module.Migrations
{
    ...
    partial class brekGPTEFCoreDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.DashboardData", b =>
                {
                    ...
                    b.Property<bool>("SynchronizeTitle")
                        ...
                        .HasColumnName("synchronizetitle");
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.Event", b =>
                {
                    ...
                    b.Property<string>("RecurrenceInfoXml")
                        ...
                        .HasColumnName("recurrenceinfoxml");
                    ...
                    b.Property<int>("RemindInSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("remindinseconds");

                    b.Property<string>("ReminderInfoXml")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reminderinfoxml");
                    ...
                    b.HasIndex("RecurrencePatternID")
                        .HasDatabaseName("ix_event_recurrencepatternid");
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.ModelDifferenceAspect", b =>
                {
                    ...
                    b.HasKey("ID")
                        .HasName("pk_modeldifferenceaspects");

                    b.HasIndex("OwnerID")
                        .HasDatabaseName("ix_modeldifferenceaspects_ownerid");
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.ReportDataV2", b =>
                {
                    ...
                    b.Property<bool>("IsInplaceReport")
                        .HasColumnType("boolean")
                        .HasColumnName("isinplacereport");

                    b.Property<string>("ParametersObjectTypeName")
                        .HasColumnType("text")
                        .HasColumnName("parametersobjecttypename");

                    b.Property<string>("PredefinedReportTypeName")
                        .HasColumnType("text")
                        .HasColumnName("predefinedreporttypename");

                    b.HasKey("ID")
                        .HasName("pk_reportdatav2");
            ...
            modelBuilder.Entity("EventResource", b =>
                {
                    ...
                    b.Property<Guid>("ResourcesKey")
                        .HasColumnType("uuid")
                        .HasColumnName("resourceskey");

                    b.HasKey("EventsID", "ResourcesKey")
                        .HasName("pk_eventresource");

                    b.HasIndex("ResourcesKey")
                        .HasDatabaseName("ix_eventresource_resourceskey");
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ApplicationUserLoginInfo", b =>
                {
                    ...
                    b.HasIndex("LoginProviderName", "ProviderUserKey")
                        .IsUnique()
                        .HasDatabaseName("ix_permissionpolicyuserlogininfo_loginprovidername_provideruse~");

                    b.ToTable("PermissionPolicyUserLoginInfo");
                });

            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Article", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ArticleDetail", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Base.FileSystemStoreObjectBase", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Chat", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ChatModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.CodeObject", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.CodeObjectCategory", b =>
                {
                    b.Property<int>("CodeObjectCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Cost", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.EmbeddingModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.FileSystemStoreObject", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.MailData", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Prompt", b =>
                {
                    b.Property<int>("PromptID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Settings", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.SimilarContentArticlesResult", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Tag", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.UsedKnowledge", b =>
                {
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CodeObjectTag", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.CodeObject", null)
                        .WithMany()
                    ...
                    b.HasOne("brekGPT.Module.BusinessObjects.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.Event", b =>
                {
                    b.HasOne("DevExpress.Persistent.BaseImpl.EF.Event", "RecurrencePattern")
                        ...
                        .HasConstraintName("fk_event_event_recurrencepatternid");
            ...
            modelBuilder.Entity("DevExpress.Persistent.BaseImpl.EF.ModelDifferenceAspect", b =>
                {
                    b.HasOne("DevExpress.Persistent.BaseImpl.EF.ModelDifference", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_modeldifferenceaspects_modeldifferences_ownerid");
            ...
            modelBuilder.Entity("EventResource", b =>
                {
                    b.HasOne("DevExpress.Persistent.BaseImpl.EF.Event", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_eventresource_event_eventsid");
                    ...
                    b.HasOne("DevExpress.Persistent.BaseImpl.EF.Resource", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_eventresource_resource_resourceskey");
                });
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ApplicationUserLoginInfo", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.ApplicationUser", "User")
                        .WithMany("UserLogins")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.ArticleDetail", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.Article", "Article")
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Chat", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.ChatModel", "ChatModel")
                        .WithMany()
                        .HasForeignKey("ChatModelID")
                        .HasConstraintName("fk_chat_chatmodel_chatmodelid");

                    b.HasOne("brekGPT.Module.BusinessObjects.Prompt", "Prompt")
                        .WithMany()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.CodeObject", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.CodeObjectCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Cost", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.ArticleDetail", "ArticleDetail")
                        .WithMany()
                    ...
                    b.HasOne("brekGPT.Module.BusinessObjects.Chat", "Chat")
                        .WithMany()
                        .HasForeignKey("ChatId")
                        .HasConstraintName("fk_cost_chat_chatid");

                    b.HasOne("brekGPT.Module.BusinessObjects.CodeObject", "CodeObject")
                        .WithMany()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.FileSystemStoreObject", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.Base.FileSystemStoreObjectBase", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.Settings", b =>
                {
                    ...
                    b.HasOne("brekGPT.Module.BusinessObjects.EmbeddingModel", "EmbeddingModel")
                        .WithMany()
            ...
            modelBuilder.Entity("brekGPT.Module.BusinessObjects.UsedKnowledge", b =>
                {
                    b.HasOne("brekGPT.Module.BusinessObjects.ArticleDetail", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleDetailId")
                    ...
                    b.HasOne("brekGPT.Module.BusinessObjects.CodeObject", "Code")
                        .WithMany()
                        .HasForeignKey("CodeObjectId")
